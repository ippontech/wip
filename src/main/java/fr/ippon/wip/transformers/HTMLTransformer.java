...
public class HTMLTransformer extends AbstractTransformer {
    ...
    public HTMLTransformer(PortletRequest portletRequest, PortletResponse portletResponse) {
        super(portletRequest);
        this.wipConfig = WIPConfigurationManager.getInstance().getConfiguration(portletRequest.getWindowID());
    ...
    public String transform(String input) throws SAXException, IOException, TransformerException {
        ...
        transformerHandler.getTransformer().setParameter("retrieveCss", wipConfig.getEnableCssRetrieving());
        transformerHandler.getTransformer().setParameter("rewriteUrl", wipConfig.getEnableUrlRewriting());
