...
<table class="configs">
    ...
    <tr>
        ...
        <td class="c2"><a
                href="<portlet:actionURL><portlet:param name="configPage" value="<%=conf%>" /></portlet:actionURL>">voir</a>
        </td>
        <td class="c3"><a
                href="<portlet:actionURL><portlet:param name="changeConfig" value="<%=conf%>" /></portlet:actionURL>">choisir</a>
        </td>
    </tr>
    <%
            }
